...
mod:dofile("scripts/mods/TourneyBalance/changes/thp_stagger_damage_changes/00_bloodlust_health")
mod:dofile("scripts/mods/TourneyBalance/changes/thp_stagger_damage_changes/01_damage_calc_changes")
