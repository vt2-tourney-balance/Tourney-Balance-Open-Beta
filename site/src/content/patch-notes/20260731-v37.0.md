...
date: 2026-07-31
---
# The Big Beta Changes (BBCs)
*Starting with this version we are working on overhauling a lot of the past changes. Over the past year the stable TB version and its lack of updates allowed certain careers and playstyles to establish themselves. Some balance changes have proven to be to effective, while others being lackluster and forgotten. It is time for a META shift! At this point I would like to make clear where Tourney Balance will be headed.*

1. Balance changes will be heavily oriented towards C3 Deathwish Dutch Spice (C3DWUTCH).
    <details>
    <summary>Detailed explanation</summary>

    With players steadily improving to the point that C3DWUTCH has become the default difficulty for in LFGs it seems fair to adjust balance changes focused on one difficulty. Not to mention the immense discrepancy between C3DWONS and C3DWUTCH makes it non-sensical to balance changes according to both at the same time.

    </details>

2. There will be more experimental changes.
    <details>
    <summary>Detailed explanation</summary>

    Fervent Huntress was our first experiment to gather some sentiment on more extreme changes. With an acceptable reception we want to move forward in a similar fashion. While Tourney Balance has mostly worked with number tweaks in the past, these changes are simply not enough to bring side-grade talents to a competitive level. Some talents are inherently too strong - we've seen in the past how *The Volans Doctrine* on Pyromancer has been made a passive - and in a similar notion we aim to do similar changes, when certain talents completely smoke out the competition. This current patch kicks off with a bunch off significant changes to spice up the META and allow more variety in talent choices and team comps. While these won't be universal Best-in-Slot choices, they should open up some new niches. More coming soon.
...
*Bash has been extremely overpowered and the previous nerf rendered bashes completely useless. This time we are bringing bashes back, but they will consume stamina. Furthermore fully consuming stamina from bashing will leave you briefly vulnerable. Thanks to SkeletonIRL for providing the initial framework of the code.*

* Reverted bash explosion radius 0.9 > 2.5
...
*Stam-Tech is a very powerful interaction and can be easily abused. The internal cooldown limits its usage to roughly once per horde. The tech may still come in clutch, but it does not need to be part of your attack combos.*
...
* **I Shall Judge You All (experimental) (OK)**
    ...
    * Ping all specials permanently (temporary in Open Beta)
